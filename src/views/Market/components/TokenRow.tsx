      ...
      >
        ...
        <Grid item md>
          <div className='flex flex-col items-center'>
            ...
            <div className='rounded bg-gradient-to-t from-[orange] to-[cyan] p-[1px]'>
              <Chip label='5.71% APR' icon={<AvatarSize size={24} />} className='rounded bg-paper-main font-bold' />
            </div>
          </div>
        </Grid>
        <Grid item md></Grid>
            ...
            <Grid item md={4}>
              ...
              <div>
                <div className='mb-1 flex justify-between'>
                  <span className='text-sm'>Available DAI:</span>
